...
# WORKFLOW — When2Call Tool-Description Perturbation Workflow
...
## 13. Configuration (where to look)

Configuration is documented separately in `docs/CONFIG.md`:

* `config.toml` schema and recommended defaults
